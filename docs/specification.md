# Axion - クロスプラットフォームファイル同期ツール仕様書 (v0.1.x のみ対応)

> **注意**: このドキュメントは v0.1.x の P2P アーキテクチャを説明しています。
> v0.2.x 以降のサーバー/クライアント方式については [README.md](../README.md) および [PROTOCOL.md](PROTOCOL.md) を参照してください。
